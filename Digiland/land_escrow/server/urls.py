...
urlpatterns = [
    ...
    path('lawyer/dashboard/', views.agent_dashboard, name='lawyer_dashboard'),
    path('official/dashboard/', views.agent_dashboard, name='official_dashboard'),
    ...
    path('admin/transaction/<uuid:transaction_id>/complete-transfer/', views.admin_complete_transfer, name='admin_complete_transfer'),
    path('admin/transaction/<uuid:transaction_id>/release/', views.admin_release_escrow, name='admin_release_escrow'),
    path('admin/transaction/<uuid:transaction_id>/reverse/', views.admin_reverse_payment, name='admin_reverse_payment'),
    ...
    path('agent/transaction-monitoring/', views.transaction_monitoring_view, name='transaction_monitoring'),
    ...
    path('parcels/<path:parcel_number>/initiate-transaction/', views.initiate_transaction, name='initiate_transaction'),
    ...
    path('messages/stream/', views.message_stream, name='messages_stream'),
    path('messages/acknowledge/', views.acknowledge_delivery, name='messages_acknowledge'),
    ...
    path('api/verification/wizard/save-step/', views_verification.verification_wizard, name='verification_wizard_api'),
    path('api/verification/wizard/<uuid:case_id>/step/<int:step>/', views_verification.verification_wizard_step, name='verification_wizard_step_api'),
    path('api/verification/wizard/<uuid:case_id>/upload-document/', views_verification.verification_document_upload, name='verification_document_upload_api'),
