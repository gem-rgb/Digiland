...
AUTH_INVALID_CREDENTIALS = register_error(ErrorDefinition(
    ...
    recovery_action="Check your credentials and try again, or reset your password.",
...
AUTH_ACCOUNT_LOCKED = register_error(ErrorDefinition(
    ...
    user_message="Your account has been temporarily locked for security reasons. Please try again later or contact support.",
...
VALIDATION_PASSWORD_TOO_SHORT = register_error(ErrorDefinition(
    ...
    category=ErrorCategory.VALIDATION,
    severity=ErrorSeverity.LOW,
    user_message="Your password must be at least 10 characters long and include a mix of letters, numbers, and symbols.",
    internal_message="Password does not meet minimum complexity requirements",
    recovery_action="Choose a stronger password with at least 10 characters.",
    http_status_code=400,
    is_retryable=False,
    log_level="INFO",
))
...
AUTH_OAUTH_ERROR = register_error(ErrorDefinition(
    ...
    recovery_action="Try again or sign in with your email and password.",
    http_status_code=401,
    is_retryable=True,
    log_level="WARNING",
))
